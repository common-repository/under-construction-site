...
$wpsm_uc_plugin_options_templates = unserialize(get_option('wpsm_uc_plugin_options_templates'));	
?>
<script>
...
<div class="row">
	<div class="post-social-wrapper clearfix">
					...
					<div class="post-social post-social-xs" id="post-social-5">
						<div class="text-center padding-all text-center">
							<div class="textbox text-white   margin-bottom settings-title">
								<?php _e('Under Construction Template','WPSM_UC_TEXT_DOMAIN'); ?>
							</div>
						</div>
					</div>
				</div>
		...
		<?php  $templates = $wpsm_uc_plugin_options_templates['templates']; ?>
		<form method="post" id="wpsm_uc_plugin_options_templates">
				...
				<div class="col-md-6 demoftr "> 
					<div class="">
						<div class="wpsme_home_portfolio_showcase">
							...
							<?php  ?>
							<img class="wpsme_img_responsive ftr_img"  src="<?php echo  WPSM_UC_PLUGIN_URL.'assets/images/demo/demo-'.$j.'.png'; ?>">
